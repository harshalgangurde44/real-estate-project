...
const UserPropertyPage = () => {
    ...
    const sendRequest = async () => {
      try {
        const response = await fetch(
          `https://backend-real-estate-keka.onrender.com/api/property/${userId}`,
          {
            method: "GET",
            headers: {
              Authorization: token,
        ...
        const propertyList = responseData.map((property) => {
          ...
          return {
            ...
            total_area: property.property_detail.total_area,
  ...
  const searchHandler = (event) => {
    ...
    const token = getAuthToken();
    fetch(
      `https://backend-real-estate-keka.onrender.com/api/property/search/${searchValue}`,
      {
        method: "GET",
        headers: {
          Authorization: token,
      ...
      .then((data) => {
        const searchedProperty = {
          ...
          total_area: data.property_detail.total_area,
  ...
  const deleteHandler = (PPD_ID) => {
    const token = getAuthToken();
    fetch(
      `https://backend-real-estate-keka.onrender.com/api/property/delete/${PPD_ID}`,
      {
        method: "DELETE",
        headers: {
  ...
  const editPropertyHandler = (PPD_ID) => {
    const token = getAuthToken();
    fetch(
      `https://backend-real-estate-keka.onrender.com/api/property/search/${PPD_ID}`,
      {
        method: "GET",
        headers: {
          Authorization: token,
